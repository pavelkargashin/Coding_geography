...
OutputFolder = parameters.TempData
exceldataFolder = parameters.InputData
keyword4search = parameters.keyword4search
excelName = parameters.excelName
...
for item in data2process:
    ...
    print 'Экспорт данных в ', str(myshape)
